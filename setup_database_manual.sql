-- Manual Database Setup for Cricket League Management System
-- Run this script in your PostgreSQL client (pgAdmin, DBeaver, or psql)

-- Connect to your PostgreSQL server as postgres user
...
-- 7. Create tables (copy from your existing V1 migration)
...
-- 11. Grant permissions on all tables to cricket_user
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO cricket_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO cricket_user;
